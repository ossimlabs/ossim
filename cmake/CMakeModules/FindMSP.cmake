...
if (MSP_INCLUDE_DIRS)
  ...
  FIND_MSP_LIBRARY(MSPntmtreC LIBS_OK)
  ...
  FIND_MSP_LIBRARY(MSPSensorSpecificServiceC LIBS_OK)
...
# These are optional. Include only if present:
  ...
  if( LIBS_OK )
    set(MSP_FOUND "YES")
    # In the ossim-csm-plugin the MSP inteface is core dumping. 
    # OSSIM_HAS_MSP is set to 0 when using ossim-csm-plugin.  The CSM
