...
#   ENDIF(NOT OSSIM_RUNTIME_BUILD_OUTPUT_DIRECTORY)
   ...
   IF(OSSIM_DEPENDENCIES)
      SET(CMAKE_LIBRARY_PATH "${CMAKE_LIBRARY_PATH};${OSSIM_DEPENDENCIES}/lib;${OSSIM_DEPENDENCIES}/lib64")
      SET(CMAKE_INCLUDE_PATH "${CMAKE_INCLUDE_PATH};${OSSIM_DEPENDENCIES}/include;${OSSIM_DEPENDENCIES}/kakadu/include;${OSSIM_DEPENDENCIES}")
   ENDIF()
#   SET(CMAKE_LIBRARY_PATH "${CMAKE_LIBRARY_PATH};/usr/lib;/usr/local/lib;/usr/lib64;/usr/lib/x86_64-linux-gnu")
   ...
   OPTION(BUILD_OSSIM_AUTOREGISTRATION "Set to ON to build and link the optional registration source bridge from ossim-autoreg." OFF)
