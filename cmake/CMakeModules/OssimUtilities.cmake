...
MACRO(SETUP_LINK_LIBRARIES)
    ...
    TARGET_LINK_LIBRARIES(${TARGET_TARGETNAME} ${TARGET_LIBRARIES} ${TARGET_EXTERNAL_LIBRARIES})
...
MACRO(OSSIM_SETUP_APPLICATION)
   ...
   IF(APPLICATION_COMMAND_LINE)
    ...
    ADD_DEPENDENCIES(${TARGET_TARGETNAME}  ${OSSIM_LIBNAME})
    
    TARGET_LINK_LIBRARIES(${TARGET_TARGETNAME} ${OSSIM_LIBNAME})
...
#        SET(CMAKE_INSTALL_RPATH "${OSSIM_COMPILE_FRAMEWORKS_INSTALL_NAME_DIR}")
   ...
   IF(LINK_INSTALL_LIB)
        IF(LINK_INSTALL_HEADERS)
           SET_TARGET_PROPERTIES(${OSSIM_LIBNAME} PROPERTIES PUBLIC_HEADER "${LINK_PUBLIC_HEADERS}")
