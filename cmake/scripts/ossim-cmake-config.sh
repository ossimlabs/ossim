...
if [ -z "$BUILD_OSSIM_AUTOREGISTRATION" ]; then
  BUILD_OSSIM_AUTOREGISTRATION=OFF
fi
if [ -z "$OSSIM_AUTOREGISTRATION_ROOT" ] && [ -d "$OSSIM_DEV_HOME/ossim-autoreg" ]; then
  export OSSIM_AUTOREGISTRATION_ROOT="$OSSIM_DEV_HOME/ossim-autoreg"
fi
...
"-DBUILD_OSSIM_AUTOREGISTRATION=$BUILD_OSSIM_AUTOREGISTRATION" \
"-DOSSIM_AUTOREGISTRATION_ROOT=$OSSIM_AUTOREGISTRATION_ROOT" \
