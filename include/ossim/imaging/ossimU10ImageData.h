...
// Description:
//
// Class declaration of ossimU10ImageData.  Specialized image data object for
...
#ifndef ossimU10ImageData_HEADER
#define ossimU10ImageData_HEADER

#include <ossim/imaging/ossimImageData.h>
#include <ossim/imaging/ossimNormalizedU10RemapTable.h>

class OSSIMDLLEXPORT ossimU10ImageData : public ossimImageData
{
public:
   ossimU10ImageData(ossimSource* source,
   ...
   ossimU10ImageData(const ossimU10ImageData &rhs);
...
protected:
   virtual ~ossimU10ImageData();
   ossimU10ImageData();

private:

   static const ossimNormalizedU10RemapTable m_remapTable;
   
TYPE_DATA
};

inline ossim_float64 ossimU10ImageData::getMinNormalizedPix() const
{
