...
//
// See document STDI-0002-1 Appendix AH: GLAS/GFM 1.0 for more info.
// 
//----------------------------------------------------------------------------
// $Id
...
public:
   ...
   /**
    * @brief Get the ImageUUID field.
    * @return The ImageUUID field as a string.
    */
   ossimString getImageUUID() const;

   /**
    * @brief Get the NumAssocDes field.
    * @return The NumAssocDes field as a string.
    */
   ossimString getNumAssocDES() const;
    ...
    * @return The NumAssocDes field as a string.
    */
   void addAssocDES(ossimString uuid);
...
protected:
    ...
    * PAN MS
    */
   char theNumAssocDES[3];

   /**
    * FIELD: AssocDES
    * 
    * vector of 36 byte UUIDs
    *
    * PAN MS
    */
   std::vector<ossimString> theAssocDES;


TYPE_DATA   
};

#endif /* matches #ifndef ossimNitfCsexrbTag_HEADER */
