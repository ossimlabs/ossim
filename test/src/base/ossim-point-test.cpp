...
int main()
{
   ...
   // Test distanceTo()
   const double delta_dp = dp1.distanceTo(dp2);
   ...
   // Test distanceTo()
   const double delta_dp3 = dp3d1.distanceTo(dp3d2);
   ...
   // Test distanceTo()
   const double delta_gp = gp1.distanceTo(gp2);
   ...
   // Test distanceTo()
   ossimEcefPoint ep2(0, 0, 0);
   const double delta_ep = ep1.distanceTo(ep2);
