 ...
 *    LambertConformalConic.h  - Is used to convert lambert conformal conic coordinates
 ...
 */
  ...
  lambertConformalConic = new LambertConformalConic( semiMajorAxis, flattening, Neys_Origin_Long, Neys_Origin_Lat,
...
{
  lambertConformalConic = new LambertConformalConic( *( n.lambertConformalConic ) );
...
Neys& Neys::operator=( const Neys &n )
{
  if( this != &n )
  {
    lambertConformalConic->operator=( *n.lambertConformalConic );
    semiMajorAxis = n.semiMajorAxis;
    flattening = n.flattening;
    Neys_Std_Parallel_1 = n.Neys_Std_Parallel_1;     
    Neys_Std_Parallel_2 = n.Neys_Std_Parallel_2; 
 ...
 */
  ...
  MapProjectionCoordinates* mapProjectionCoordinates =
     lambertConformalConic->convertFromGeodetic( geodeticCoordinates );
 ...
 */
  ...
  GeodeticCoordinates* geodeticCoordinates = 
     lambertConformalConic->convertToGeodetic( mapProjectionCoordinates );
  double longitude = geodeticCoordinates->longitude();
  double latitude = geodeticCoordinates->latitude();
