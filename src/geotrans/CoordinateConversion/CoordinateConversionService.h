...
namespace MSP
{
  ...
  namespace CCS
  {
    ...
    class CoordinateSystem;
     ...
     /* Symbolic constants */
     const int NUMBER_COORD_SYS = 40;      // Number of coordinate systems
      ...
      */
      void convertSourceToTargetCollection(
         ...
         * which provides access to ellipsoid parameter information.
         * 
         */
...
//compiler bug on solaris 8. Parameters needs to be public
     ...
     public:
        ...
        struct Coordinate_System_Row
        {
		   ...
		   void set( const char *name, const char *code)
		   {
			   strcpy( Name, name );
			   strcpy( Code, code );
		   }
