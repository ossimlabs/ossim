...
extern "C"
{
void ossimJpegErrorExit12 (j_common_ptr cinfo)
{
...
void init_source12 (j_decompress_ptr /* cinfo */)
{
 ...
 */
boolean fill_input_buffer12 (j_decompress_ptr cinfo)
{
 ...
 */
void skip_input_data12 (j_decompress_ptr cinfo, long num_bytes)
{
  ossimJpegSourceMgrPtr12 src = (ossimJpegSourceMgrPtr12) cinfo->src;
 ...
 * for error exit.
 */
void term_source12 (j_decompress_ptr /* cinfo */)
{
 ...
 */
void ossimJpegMemorySrc12(j_decompress_ptr cinfo,
                          const JOCTET * buffer,
                          std::size_t bufsize)
{
