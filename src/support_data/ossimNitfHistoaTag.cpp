...
//
// See document Vol1-AppAK-HISTOA table 6.5 for more info.
//
//----------------------------------------------------------------------------
...
static ossimTrace traceDebug("ossimNitfHistoaTag:debug");

static const int FOREVER = 1;

const std::string ossimNitfHistoaTag::CETAG_KW = "HISTOA";

ossimNitfHistoaTag::ossimNitfHistoaTag()
   : ossimNitfGenericTag("HISTOA")
{
...
ossimNitfHistoaTag::ossimNitfHistoaTag(ossim_uint32 tagLength)
   : ossimNitfGenericTag("HISTOA", tagLength)
{
   initializeFieldDefinitions();

}
void ossimNitfHistoaTag::initializeFieldDefinitions()
{
   FIELD_DEFINITIONS =
   {
        /**
      ...
      * TBD Other
      */
      {ossim::nitf::SYSTYPE_KW, 20, ASCII},
        /**
      * Field: PC
      *
      ...
      */
      {ossim::nitf::REMAP_FLAG_KW, 1, U_INT},
        /**
      * Field: LUTID
      *
      ...
      */
      {ossim::nitf::NEVENTS_KW, 2, U_INT},
      {ossim::nitf::NEVENTS_KW, LOOP_START},
             /**
          * Field: PDATE
          *
        ...
        */
         ...
         */
         {ossim::nitf::NIPCOM_KW, 1, U_INT},
         {ossim::nitf::NIPCOM_KW, LOOP_START},
              /**
            * Field IPCOM
            *
            ...
            */
            {ossim::nitf::IPCOM_KW, 80, ASCII},
         {ossim::nitf::NIPCOM_KW, LOOP_END},
               /**
          * Field: IBPP
          *
         ...
         */
        {ossim::nitf::DISP_FLAG_KW, 1, U_INT},
           /**
         * Field ROT_FLAG
         *
         ...
         * rotation.
         */
         {ossim::nitf::ROT_FLAG_KW, 1, U_INT},
         {ossim::nitf::ROT_FLAG_KW + " = 1", IF_STATEMENT_START},
                 /**
            * Field: ROT_ANGLE
            *
            ...
            */
            {ossim::nitf::ROT_ANGLE_KW, 8, U_DOUBLE, 4},
         {ossim::nitf::ROT_FLAG_KW + " = 1", IF_STATEMENT_END},
           /**
         * Field: ASYM_FLAG
         *
         ...
         */
         {ossim::nitf::ASYM_FLAG_KW, 1, U_INT},
         {ossim::nitf::ASYM_FLAG_KW + " = 1", IF_STATEMENT_START},
              /**
            * Field: ZOOMROW
            *
            ...
            */
            {ossim::nitf::ZOOMROW_KW, 7, U_DOUBLE, 4},
              /**
            * Field: ZOOMCOL
            *
            ...
            * field is conditional on the ASYM_FLAG field.
            */
            {ossim::nitf::ZOOMCOL_KW, 7, U_DOUBLE, 4},
         {ossim::nitf::ASYM_FLAG_KW + " = 1", IF_STATEMENT_END},
           /**
         * Field: PROJ_FLAG
         *
         ...
         */
         {ossim::nitf::PROJ_FLAG_KW, 1, U_INT},
           /**
         * Field: SHARP_FLAG
         *
         ...
         */
         {ossim::nitf::SHARP_FLAG_KW, 1, U_INT},
         {ossim::nitf::SHARP_FLAG_KW + " = 1", IF_STATEMENT_START},
              /**
            * Field: SHARPFAM
            *
            ...
            * sharpening database.
            */
            {ossim::nitf::SHARPMEM_KW, 2, INT},
         {ossim::nitf::SHARP_FLAG_KW + " = 1", IF_STATEMENT_END},
           /**
         * Field MAG_FLAG
         *
         ...
         */
         {ossim::nitf::MAG_FLAG_KW, 1, U_INT},
         {ossim::nitf::MAG_FLAG_KW + " = 1", IF_STATEMENT_START},
              /**
            * Field MAG_LEVEL
            *
            ...
            */
            {ossim::nitf::MAG_LEVEL_KW, 7, U_DOUBLE, 4},
         {ossim::nitf::MAG_FLAG_KW + " = 1", IF_STATEMENT_END},
           /**
         * Field: DRA_FLAG
         *
         ...
         */
         {ossim::nitf::DRA_FLAG_KW, 1, U_INT},
         {ossim::nitf::DRA_FLAG_KW + " = 1", IF_STATEMENT_START},
                 /**
            * Field: DRA_MULT
            *
            ...
            */
            {ossim::nitf::DRA_MULT_KW, 7, U_DOUBLE, 3},
              /**
            * Field: DRA_SUB
            *
            ...
            * 999.999. This field is conditional on the DRA_FLAG field being equal to 1.
            */
            {ossim::nitf::DRA_SUB_KW, 5, INT},
         {ossim::nitf::DRA_FLAG_KW + " = 1", IF_STATEMENT_END},
           /**
         * Field: TTC_FLAG
         *
         ...
         */
         {ossim::nitf::TTC_FLAG_KW, 1, U_INT},
         {ossim::nitf::TTC_FLAG_KW + " = 1", IF_STATEMENT_START},
              /**
            * Field: TTCFAM
            *
            ...
            */
            {ossim::nitf::TTCMEM_KW, 2, INT},
         {ossim::nitf::TTC_FLAG_KW + " = 1", IF_STATEMENT_END},
            /**
          * Field: DEVLUT_FLAG
          *
          ...
          * given.
          */
         {ossim::nitf::DEVLUT_FLAG_KW, 1, U_INT},
            /**
          * Field OBPP
          *
         ...
         */
         {ossim::nitf::OUTBWC_KW, 10, ASCII},
      {ossim::nitf::NEVENTS_KW, LOOP_END}
   };
}

ossimString ossimNitfHistoaTag::getClassName() const
{
   return ossimString("ossimNitfHistoaTag");
}
