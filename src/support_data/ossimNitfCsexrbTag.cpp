...
ossimNitfGenericTag::definition ossimNitfGenericTag::FIELD_DEFINITIONS[NUM_DEFINITIONS] =
{
   ...
   {"SENSOR_TYPE == F", IF_STATEMENT_START},
      {"TIME_STAMP_LOC", 1},
      {"TIME_STAMP_LOC == 0", IF_STATEMENT_START},
      ...
      {"RESERVED_FIELD_MASK:0 == 1", IF_STATEMENT_START},
         ...
         {"NUM_IMG_OPS_DATA n", LOOP_START},
            ...
            {"NUM_INDICES m", LOOP_START},
               {"INDEX_IN_IMG_OP_ID INDEX_SIZE", VARIABLE_LENGTH},
            ...
            {"NUM_QUALITY_METRICS m", LOOP_START},
               ...
               {"QUALITY_METRIC_VALUE QUALITY_METRIC_NAME_LEN", VARIABLE_LENGTH},
