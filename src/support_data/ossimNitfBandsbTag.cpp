...
void ossimNitfBandsbTag::initializeFieldDefinitions()
{
   ...
   {
      {"COUNT", 5, 1},
      {"RADIOMETRICQUANTITY", 24, 0, 0, "Uncalibrated"},
      {"RADIOMETRICQUANTITY_UNIT", 1, 0, 0, "Uncalibrated"},
      {"SCALE FACTOR", 4, 0, 0, "1"},
      {"ADDITIVEFACTOR", 4, 0, 0, "0"},
      {"ROW_GSD", 7, 3, 3},
      {"ROW_GSD_UNIT", 1, 0, 0, "M"},
      {"COL_GSD", 7, 3, 3},
      {"COL_GSD_UNIT", 1, 0, 0, "M"},
      {"SPT_RESP_ROW", 7, 3, 3},
      {"SPT_RESP_UNIT_ROW", 1, 0},
      {"SPT_RESP_COL", 7, 3, 3},
      {"SPT_RESP_UNIT_COL", 1, 0},
      {"DATA_FLD_1", 48, 0},
      {"EXISTENCE_MASK", 4, 0, 0, ossimString(std::string{char(159), char(199), char(16), char(0)})},//10011111 11000111 00010000 00000000
      {"RADIOMETRICADJUSTMENTSURFACE", 24, 0, 0, "APERTURE"},
