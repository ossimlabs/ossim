...
void ossimNitfCswrpbTag::initializeFieldDefinitions()
{
   FIELD_DEFINITIONS =
   {
      ...
      {ossim::nitf::NUM_SETS_WARP_DATA_KW, LOOP_START},
         ...
         {ossim::nitf::LINE_POLY_ORDER_M2_KW, LOOP_START},
            {ossim::nitf::LINE_POLY_ORDER_M1_KW, LOOP_START},
               {ossim::nitf::A_KW, 21, ASCII},
            {ossim::nitf::LINE_POLY_ORDER_M1_KW, LOOP_END},
         {ossim::nitf::LINE_POLY_ORDER_M2_KW, LOOP_END},
         {ossim::nitf::SAMP_POLY_ORDER_N2_KW, LOOP_START},
            {ossim::nitf::SAMP_POLY_ORDER_N1_KW, LOOP_START},
               {ossim::nitf::B_KW, 21, ASCII},
            {ossim::nitf::SAMP_POLY_ORDER_N1_KW, LOOP_END},
         {ossim::nitf::SAMP_POLY_ORDER_N2_KW, LOOP_END},
