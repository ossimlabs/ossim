...
ossim_uint32 ossimUtmProjection::getPcsCode() const
{
   ...
   if ( theDatum )
   {
      ossim_uint32 zone = (ossim_uint32)theZone;
      ossim_uint32 epsg_code= theDatum->epsgCode();

      switch ( epsg_code )
      {
         case 6326: // WGE - World Geodetic System 1984
         {
            if ( theHemisphere == 'N' )
            {
               code = 32600 + zone;
         ...
         case 6269: // NAR-C - NORTH AMERICAN 1983, CONUS
         {
            if ( theHemisphere == 'N' )
            {
               code = 26900 + zone;
         ...
         case 6322: // WGD -  World Geodetic System 1972
         {
            if ( theHemisphere == 'N' )
            {
               code = 32200 + zone;
         ...
         case 6327: // NAS-C - NORTH AMERICAN 1927, CONUS
         {
            if ( theHemisphere == 'N' )
            {
               code = 26700 + zone;
         ...
         default:
         {
            ...
            //---
            if  ( theHemisphere == 'N' ) // Northern hemisphere.
            {
               code = 16000 + zone;
            }
            else // Southern hemisphere.
