...
bool ossimNitfRsmModel::initializeModel( const ossimNitfRsmpcaTag* rsmpcaTag )
{
   ...
   if ( rsmpcaTag )
   {
      m_pca_iid = rsmpcaTag->getIid().trim();
      m_pca_edition = rsmpcaTag->getEdition().trim();
...
bool ossimNitfRsmModel::initializeModel( const ossimNitfRsmpiaTag* rsmpiaTag )
{
   ...
   if ( rsmpiaTag )
   {
      m_pia_iid     = rsmpiaTag->getIid().trim();
      m_pia_edition = rsmpiaTag->getEdition().trim();
